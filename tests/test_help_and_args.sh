...
assert_contains "-h shows --vms-file"       "--vms-file"        "$HELP"
assert_contains "-h shows --inv-file"       "--inv-file"        "$HELP"
assert_contains "-h shows --svc-file"       "--svc-file"        "$HELP"
assert_contains "-h shows --sw-file"        "--sw-file"         "$HELP"
